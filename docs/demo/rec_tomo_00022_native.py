...
"""
TomoPy example script to reconstruct the Elettra data saved as elettra native dxchange (data in sinogram order)
"""
...
if __name__ == '__main__':
    ...
    proj, flat, dark, th = dxchange.read_aps_32id(fname)
    ...
    fname='tomobank/' + tomobank_id + '/' + tomobank_id
